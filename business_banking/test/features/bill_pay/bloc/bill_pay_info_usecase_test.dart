...
void main() {
  ...
  //   BillPayInfoViewModel model;
  //   //   DateTime date = DateTime.now();
  //   BillPayInfoEntity entity = BillPayInfoEntity(
  //     rules: RulesEntity(
  //       memoLimit: 256,
  //       paymentMax: 100000.00,
  //       paymentMin: 1.00,
  ...
  //   );
  //
  //   ExampleLocator().repository.create<BillPayInfoEntity>(entity, null);
  //
  //   BillPayInfoUseCase useCase = BillPayInfoUseCase((viewModel) {
  //     model = viewModel;
  //   });
  //
  //   useCase.create();
  ...
  //   // final _scope = ExampleLocator().repository.containsScope<
  //   //     BillPayInfoEntity>();
  //   // var clearEntity = ExampleLocator().repository.get<BillPayInfoEntity>(
  //   //     _scope);
  //   // expect(clearEntity, BillPayInfoEntity(fromAccounts: entity.fromAccounts));
  //   // });
  // });
}
