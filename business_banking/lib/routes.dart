...
import 'package:business_banking/features/stocks/ui/stocks_details/stocks_details_widget.dart';
...
abstract class BusinessBankingRouter {
  ...
  static const String stocksDetailsRoute = "/stockDetail";
  ...
  static Widget generate(String name) {
    switch (name) {
      ...
      case stocksDetailsRoute:
        return StocksDetailsWidget();
