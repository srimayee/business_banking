...
class CustomerDetailUseCase extends UseCase {
  Function(ViewModel) _viewModelCallBack;

  RepositoryScope _scope;

  CustomerDetailUseCase(Function(ViewModel) viewModelCallBack)
      : assert(viewModelCallBack != null),
        _viewModelCallBack = viewModelCallBack;

  void create() async {
    _scope =
        ExampleLocator().repository.containsScope<CustomerEntity>();
    if (_scope == null) {
  ...
  CustomerDetailViewModel buildViewModel(
      CustomerEntity entity) {
    return CustomerDetailViewModel(customerEntity: entity);
  }
}
