...
class CreditCardPaymentRequestPresenter extends Presenter<CreditCardBloc,
    CreditCardPaymentRequestViewModel, CreditCardPaymentRequestScreen> {
  @override
  Stream<CreditCardPaymentRequestViewModel> getViewModelStream(
      CreditCardBloc bloc) {
  ...
  @override
  CreditCardPaymentRequestScreen buildScreen(BuildContext context,
      CreditCardBloc bloc, CreditCardPaymentRequestViewModel viewModel) {
