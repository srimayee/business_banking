...
//     final entity = ExampleLocator().repository.get<TransferFundsEntity>(_scope!);
//     TransferFundsEntity updatedEntity = entity.merge(fromAccount: fromAccount) as TransferFundsEntity;
...
//     ExampleLocator().repository.update<TransferFundsEntity>(_scope!, updatedEntity as TransferFundsEntity);
//     _viewModelCallBack(buildViewModelForLocalUpdate(updatedEntity));
//   }
