...
//             (viewModel) => transferFundsViewModelPipe.send(viewModel as TransferFundsViewModel));
//     transferFundsViewModelPipe.whenListenedDo(() {
//       _fundsUseCase.create();
//     });

//     _confirmationUseCase = TransferConfirmationUseCase((viewModel) => confirmationViewModelPipe.send(viewModel as TransferConfirmationViewModel));
