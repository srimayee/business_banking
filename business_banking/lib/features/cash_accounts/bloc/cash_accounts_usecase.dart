...
class CashAccountsUseCase extends UseCase {
  ...
  CashAccountsListViewModel buildViewModel(CashAccountsListEntityModel cashAccountsListEntityModel) {
    return CashAccountsListViewModel(
        cashAccountEntityModel: cashAccountsListEntityModel.cashAccountsEntityModel);
  }
