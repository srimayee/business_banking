...
class SideCashGetEnrollmentFormService extends  EitherService<JsonRequestModel, SideCashGetEnrollmentFormResponseModel>  {
  ...
  @override
  SideCashGetEnrollmentFormResponseModel parseResponse(Map<String, dynamic> jsonResponse) {
    print("json repsonse: $jsonResponse");
