...
class StocksPresenter extends Presenter<StocksBloc, StocksViewModel, StocksScreen> {
  @override
  StocksScreen buildScreen(BuildContext context, StocksBloc bloc, StocksViewModel viewModel) {
