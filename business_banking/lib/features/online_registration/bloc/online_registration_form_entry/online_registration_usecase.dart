...
class OnlineRegistrationUseCase extends UseCase {
  ...
  void updateCardHolderName(String cardHolderName) {
    ...
    if (cardHolderName.contains(RegExp(r"^[a-zA-Z ]*$")) == true) {
      ...
      // ExampleLocator()
      //     .repository
      //     .update<OnlineRegistrationEntity>(_scope!, entity);
  ...
  Future<void> submitForm() async {
    ...
    print(
        'check status of submitForm : ${checkUserInputEntity(entity) == UserFormInputStatus.valid}');
    print('entity cardHolderName: ${entity.cardHolderName}');
    print('entity cardNumber: ${entity.cardNumber}');
    print('entity ssnLastFourDigits: ${entity.ssnLastFourDigits}');
  ...
  UserFormInputStatus checkUserInputEntity(OnlineRegistrationEntity entity) {
    ...
    // entity.ssnLastFourDigits!.length == 4 &&
